...
impl PittoreColor {
    ...
    pub const BLACK: PittoreColor = PittoreColor::rgb(0.0, 0.0, 0.0);

    /// A fully white color, i.e. #FFFFFF or #FFFFFFFF.
    pub const WHITE: PittoreColor = PittoreColor::rgb(1.0, 1.0, 1.0);

    /// A fully transparent color, i.e. #00000000.
    pub const TRANSPARENT: PittoreColor = PittoreColor::rgba(0.0, 0.0, 0.0, 0.0);


    /// A fully green color, i.e. #FF0000 or #FF000000.
    pub const RED: PittoreColor = PittoreColor::rgb(1.0, 0.0, 0.0);

    /// A fully green color, i.e. #00FF00 or #00FF0000.
    pub const GREEN: PittoreColor = PittoreColor::rgb(0.0, 1.0, 0.0);

    /// A fully blue color, i.e. #0000FF or #0000FF00.
    pub const BLUE: PittoreColor = PittoreColor::rgb(0.0, 0.0, 1.0);

    /// A fully magenta color, i.e. #FF00FF or #FF00FF00.
    pub const MAGENTA: PittoreColor = PittoreColor::rgb(1.0, 0.0, 1.0);
}
